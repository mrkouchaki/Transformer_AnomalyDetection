...
class TimeSeriesBERT(nn.Module):
    def __init__(self, bert_model_name='bert-base-uncased'):
        ...
        self.sequence_length = 10  # This should match with what you are using in dataset preparation
        # You need to embed each of the sequence's features (2 features per timestamp) to the BERT dimension.
...
batch_size = 20
sequence_length = 10
max_samples = 500000  # You can limit the maximum number of samples to read
